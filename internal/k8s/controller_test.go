...
func TestFindIngressesForSecret(t *testing.T) {
	...
	for _, test := range testCases {
		t.Run(test.desc, func(t *testing.T) {
			...
			templateExecutor, err := configs.NewTemplateExecutor("../configs/templates/nginx-plus.tmpl", "../configs/templates/nginx-plus.ingress.tmpl", "../configs/templates/wallarm-tarantool.tmpl", true, true, []string{"127.0.0.1"}, 8080, false)
			if err != nil {
