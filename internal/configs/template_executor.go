...
func NewTemplateExecutor(mainTemplatePath string, ingressTemplatePath string, wallarmTarantoolTemplatePath string, healthStatus bool, nginxStatus bool, nginxStatusAllowCIDRs []string, nginxStatusPort int, stubStatusOverUnixSocketForOSS bool) (*TemplateExecutor, error) {
