...
func createTestConfigurator() (*Configurator, error) {
	templateExecutor, err := NewTemplateExecutor("templates/nginx-plus.tmpl", "templates/nginx-plus.ingress.tmpl", "templates/wallarm-tarantool.tmpl", true, true, []string{"127.0.0.1"}, 8080, false)
	if err != nil {
		return nil, err
	}
